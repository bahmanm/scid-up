...
namespace eval ::scid_test::gui_fixtures::tourney_window {
    variable bindCalls {}
    variable focusCalls {}
}

proc ::scid_test::gui_fixtures::tourney_window::setup {registryVar} {
    ...
    set ::scid_test::gui_fixtures::tourney_window::bindCalls {}
    set ::scid_test::gui_fixtures::tourney_window::focusCalls {}

    set ::language E

    array set ::tr {
        ScidUp ScidUp
        WindowsTmt WindowsTmt
        Country Country
        Event Event
        Site Site
        Player Player
        ...
        Defaults Defaults
        TmtLimit: TmtLimit:
        TmtSortDate TmtSortDate
        TmtSortPlayers TmtSortPlayers
        TmtSortGames TmtSortGames
        TmtMeanElo TmtMeanElo
    }
    ...
    ::scid_test::mocks::stubCommand stubbedCommands ::utils::validate::Date {name1 name2 op} {
        return
    }
    ...
    ::scid_test::mocks::stubCommand stubbedCommands bind {w seq script} {
        lappend ::scid_test::gui_fixtures::tourney_window::bindCalls [list $w $seq $script]
        return
    }

    ::scid_test::mocks::stubCommand stubbedCommands focus {w} {
        lappend ::scid_test::gui_fixtures::tourney_window::focusCalls $w
        return
    }
    ...
    foreach cmd {frame label entry button checkbutton combobox} {
...
proc ::scid_test::gui_fixtures::tourney_window::cleanup {registryVar} {
    upvar 1 $registryVar stubbedCommands
...
proc ::scid_test::gui_fixtures::tourney_window::bindCalls {} {
    return $::scid_test::gui_fixtures::tourney_window::bindCalls
}

proc ::scid_test::gui_fixtures::tourney_window::focusCalls {} {
    return $::scid_test::gui_fixtures::tourney_window::focusCalls
}
